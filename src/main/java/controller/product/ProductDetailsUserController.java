...
@WebServlet(value = "/productDetailsUser.do")
public class ProductDetailsUserController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        req.getRequestDispatcher("views/detailUserProduct.jsp").forward(req, resp);
    }
}

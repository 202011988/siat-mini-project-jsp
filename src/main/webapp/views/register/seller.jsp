...
<div id="container">
  <!-- action, method -->
  <form action="/registerSeller.do" method="POST" id="insertForm" onsubmit="checkData()">
    <table align="center" cellpadding="5" cellspacing="1" width="600" border="1">
      ...
      <tr>
        <td width="230" height="20">
          <p align="center"><b><span style="font-size:12pt;">사업자등록번호</span></b></p>
        </td>
        <td width="450" height="20" align="center">
          <b>
		        		<span style="font-size:12pt;">
		        			<input type="text" name="registrationNuber" size="30">
		        		</span>
          </b>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td width="450" height="20" align="center">
          <b>
		        		<span style="font-size:12pt;">
		        			<input type="text" name="sellerName" size="30">
		        		</span>
          </b>
        </td>
      </tr>
      ...
      <tr>
        <td width="230" height="20">
          <p align="center"><b><span style="font-size:12pt;">상호명</span></b></p>
        </td>
        <td width="450" height="20" align="center">
          <b>
		        		<span style="font-size:12pt;">
		        			<input type="text" name="storeName" size="30">
		        		</span>
          </b>
        </td>
      </tr>

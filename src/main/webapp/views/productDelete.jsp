		...
		<table align="center" cellpadding="5" cellspacing="1" width="600" border="1">
			<tr>
				<td width="230" height="20">
					<p align="center"><b><span style="font-size:12pt;">삭제할 제품 id</span></b></p>
				</td>
				<td width="450" height="20" align="center">
					<b>
		        		<span style="font-size:12pt;">
		        			<input type="number" name="productId" value="${requestScope.product.id}">
		        		</span>
					</b>
				</td>
			</tr>
			...
			<tr>
				...
				<td width="450" height="20" align="center">
					<b>
		        		<span style="font-size:12pt;">
		        			<input type="text" name="name" size="30" value = "${requestScope.product.name}" readonly>
		        		</span>
					</b>
				</td>
			</tr>
